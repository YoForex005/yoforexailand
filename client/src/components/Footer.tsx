        ...
        <div className="grid lg:grid-cols-8 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              className="mb-6"
            >
              <img src='/logo.png' alt='YoForex logo' className='w-[250px] mb-5 ml-[0px] pl-[0px]' />
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 text-neutral-400">
                <Mail className="w-5 h-5 shrink-0 text-primary-400" />
                <span>support@yoforex.net</span>
              </div>
              <div className="flex items-center space-x-3 text-neutral-400">
                <Phone className="w-5 h-5 shrink-0 text-accent-400" />
                <span>+44 330 027 2265</span>
              </div>
              <div className="flex items-start space-x-3 text-neutral-400">
                <MapPin className="w-5 h-5 shrink-0 text-primary-400 mt-1" />
