    ...
    <div className="min-h-screen bg-neutral-950 text-white font-inter flex items-center justify-center">
      <div className="text-center max-w-md mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/" className="bg-gradient-primary text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition-shadow inline-flex items-center justify-center space-x-2">
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <Link href="/features" className="text-primary-400 hover:text-primary-300 transition-colors">
              Features
            </Link>
            <Link href="/resources" className="text-primary-400 hover:text-primary-300 transition-colors">
              Resources
            </Link>
