  ...
  const faqSections = [
    {
      ...
      questions: [
        {
          question: 'How do I install YoForex AI on API?',
          answer: 'Download the EA file from your account dashboard, copy it to your API experts folder, restart API, and drag the EA onto your chart. Our setup guide provides detailed step-by-step instructions.'
        },
        {
      ...
      questions: [
        {
          ...
          answer: 'Check your API keys are correctly entered and have sufficient credits. Verify your internet connection and API settings allow external URLs. Use the built-in API tester to diagnose connection issues.'
        },
        {
          question: 'Why are my notifications not working?',
          answer: 'Ensure API mobile notifications are enabled in your terminal settings. For Telegram, verify your bot token is correct and the bot is added to your chat. Check notification settings in the EA panel.'
        },
        {
