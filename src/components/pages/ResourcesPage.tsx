      ...
      resources: [
        {
          ...
          expandedContent: {
            ...
            details: [
              ...
              'Notification setups (API/Telegram) and custom workflow creation',
              ...
              <div className="space-y-4">
                {category.resources.map((resource, resourceIndex) => (
                  <motion.div
                    ...
                    className={`p-4 rounded-lg border transition-all duration-200 cursor-pointer ${resource.featured
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="flex items-center space-x-2">
                          <h4 className={`font-semibold ${resource.featured ? 'text-primary-400' : 'text-white'
                            }`}>
                            {resource.name}
                          </h4>
                          {resource.featured && (
