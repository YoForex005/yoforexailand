            ...
            >
              ...
              <div className="mt-8 pt-6 border-t border-neutral-800/50">
                ...
                <div className="space-y-2 text-sm">
                  <Link to={"/help-center"} className="block text-primary-400 hover:text-primary-300 transition-colors">
                    📚 Help Center
                  </Link>
                  <Link to={"/community-forum"} className="block text-primary-400 hover:text-primary-300 transition-colors">
                    💬 Community Forum
                  </Link>
                  <Link to={"/status"} className="block text-primary-400 hover:text-primary-300 transition-colors">
                    📊 System Status
                  </Link>
                  <Link to={"/API-documentation"} className="block text-primary-400 hover:text-primary-300 transition-colors">
                    📖 API Documentation
                  </Link>
                </div>
              </div>
