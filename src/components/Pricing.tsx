        ...
        >
          ...
          <div className="inline-flex items-center bg-gradient-glass backdrop-blur-sm border border-neutral-800/50 rounded-xl p-1">
            <button
              ...
              className={`px-6 py-2 rounded-lg font-medium transition-all duration-300 ${!isAnnual
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              >
                ...
                {/* Card */}
                <div className={`relative bg-gradient-glass backdrop-blur-sm border-2 ${plan.popular ? 'border-accent-500/50' : 'border-neutral-800/50'
                  ...
                  <div className="relative z-10">
                    ...
                    <Link to={"/contact-support"}>
                      <motion.button
                        ...
                        className={`w-full py-4 rounded-xl font-semibold text-lg relative overflow-hidden group transition-all duration-300 ${plan.popular
