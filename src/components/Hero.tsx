...
const Hero: React.FC<HeroProps> = ({ onNavigateToDashboard, onNavigateToSignup }) => {
  ...
  const metricDetails = {
    traders: {
      ...
      contact: 'Join our growing enterprise community today'
    },
    analyses: {
      title: 'Analytics Operations Completed',
      details: [
      ...
      contact: 'Scale your analytics operations with proven reliability'
    },
    winRate: {
    ...
    uptime: {
      ...
      contact: 'For SLA details and enterprise support: support@yoforex.co.in'
    }
  };
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <motion.div 
                className="bg-gradient-glass backdrop-blur-sm border border-neutral-800/50 rounded-lg p-4 text-center cursor-pointer hover:border-neutral-700/50 transition-all duration-300"
                whileHover={{ scale: 1.02 }}
                onClick={() => toggleMetric('traders')}
              >
            ...
            {expandedMetric && (
              <motion.div
                ...
                className="mt-6 bg-gradient-glass backdrop-blur-sm border border-neutral-800/50 rounded-lg p-6"
              >
                <h4 className="text-lg font-semibold text-white mb-4">
                  {metricDetails[expandedMetric as keyof typeof metricDetails].title}
                </h4>
                <ul className="space-y-2 mb-4">
                  {metricDetails[expandedMetric as keyof typeof metricDetails].details.map((detail, index) => (
                ...
                <p className="text-primary-400 text-sm mb-4">
                  {metricDetails[expandedMetric as keyof typeof metricDetails].contact}
                </p>
                <motion.button
