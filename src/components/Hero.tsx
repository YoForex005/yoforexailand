        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-neutral-300">50K+ Users • 1M+ Analyses • 99.9% Uptime • SOC 2 Compliant</span>
            </motion.div>
            ...
            >
              <motion.div 
                ...
                onHoverStart={() => setHoveredMetric('Users')}
                onHoverEnd={() => setHoveredMetric(null)}
                onClick={() => setHoveredMetric(hoveredMetric === 'Users' ? null : 'Users')}
              >
                <div className="text-2xl font-bold text-primary-400">{metrics.Users.toLocaleString()}</div>
                  ...
                  {hoveredMetric === 'Users' && (
                    ...
                    >
                      <div className="space-y-2">
                        {metricDetails.Users.details.map((detail, index) => (
